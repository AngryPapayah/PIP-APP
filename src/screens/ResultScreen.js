...
export default function ResultScreen({ navigation, route }) {
    ...
    const getRewardForLevel = (level) => {
        switch (level) {
            case 2:
                return { name: t.rewards.foodBowl.name, image: require('../../public/images/food.png'), description: t.rewards.foodBowl.description };
            case 3:
                return { name: t.rewards.hamsterWheel.name, image: require('../../public/images/wheel.png'), description: t.rewards.hamsterWheel.description };
            default:
                return null;
        }
    };
